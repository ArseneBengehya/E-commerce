    ...
    <footer className="w-full bg-zinc-950 text-zinc-400 text-[11px] border-t border-zinc-800/50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div className="space-y-2">
          ...
          <p className="leading-relaxed text-zinc-500 max-w-[200px]">
            Votre marché moderne pour une expérience shopping premium, simple et rapide.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1.5 font-medium">
            ...
            <li>
              <Link href="/shop?cat=tech" className="hover:text-primary transition-colors">Électronique & Tech</Link>
            </li>
            <li>
              <Link href="/shop?cat=mode" className="hover:text-primary transition-colors">Mode & Tendances</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1.5 font-medium">
            <li>
              <Link href="/profil" className="hover:text-primary transition-colors">Mon compte</Link>
            </li>
            <li>
              <Link href="/profil/orders" className="hover:text-primary transition-colors">Mes commandes</Link>
            </li>
            <li>
              <Link href="/favorite" className="hover:text-primary transition-colors">Liste d'envies</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1.5 font-medium">
            ...
            <li>
              <Link href="/conditions" className="hover:text-primary transition-colors">CGV / CGU</Link>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-zinc-900 bg-zinc-950/80 py-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-zinc-500 font-medium">
          ...
          {/* Copyright */}
          <div>
            © {currentYear} <span className="text-zinc-300 font-bold">{AppName}</span>. Tous droits réservés.
          </div>
          ...
          <div className="flex items-center gap-3 text-zinc-600 dark:text-zinc-500">
            <span className="text-[10px] uppercase tracking-wide font-bold mr-1">Paiement sécurisé :</span>
            <FaCcVisa size={18} className="hover:text-zinc-400 transition-colors" />
            <FaCcMastercard size={18} className="hover:text-zinc-400 transition-colors" />
            <FaCcPaypal size={18} className="hover:text-zinc-400 transition-colors" />
          </div>
